module "add-11-module_network" {
  source  = "app.terraform.io/dpt-mzc/10-module_network/aws"
  version = "1.0.0"
...
module "add-11-module_sg" {
  source  = "app.terraform.io/dpt-mzc/10-module_sg/aws"
  version = "1.0.0"
...
module "add-11-module_rds" {
  source  = "app.terraform.io/dpt-mzc/10-module_rds/aws"
  version = "1.0.0"
...
module "add-11-module_web" {
  source  = "app.terraform.io/dpt-mzc/10-module_web/aws"
  version = "1.0.0"
...
module "add-11-module_was" {
  source = "app.terraform.io/dpt-mzc/10-module_was/aws"
  version = "1.0.0"
